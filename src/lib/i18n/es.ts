export const es = {
  ...
  sinActividadHoy: "Sin actividad hoy",

  editarContacto: "Editar Contacto",
  nuevoContacto: "Nuevo Contacto",
  datosContacto: "Completa los datos del contacto para su gestión",
  nombreCompleto: "Nombre Completo",
  telefono: "Teléfono",
  estado: "Estado",
  notasObservaciones: "Notas y Observaciones",
  cancelar: "Cancelar",
  actualizarContacto: "Actualizar Contacto",
  crearContacto: "Crear Contacto",
  nombreObligatorio: "El nombre es obligatorio",
  contactoActualizado: "Contacto actualizado",
  contactoAnadido: "Contacto añadido",
  errorGuardar: "Error al guardar",
  ejemploNombre: "Ej. Juan Pérez",
  detallesRelevantes: "Detalles relevantes del contacto...",
  guardando: "Guardando...",
  guardarContacto: "Guardar Contacto",
  estadoNuevo: "Nuevo",
  estadoHabitual: "Habitual",
  estadoVip: "VIP",
  ...
  contactaSoporte: "Contacta con soporte directamente:",
  whatsappSoporte: "WhatsApp Soporte",
  correoElectronico: "Correo Electrónico",
  limpiarNotificaciones: "Limpiar notificaciones",
  ayuda: "Ayuda",
  ajustes: "Ajustes",
