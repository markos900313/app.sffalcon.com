...
export default function LegalPage() {
  ...
  const legalDict = language === "en" ? en.legal : es.legal;

  const renderTextWithLinks = (text: string) => {
    const parts = text.split(/({privacyLink}|admin@sffalcon\.com|\+34 604 989 742)/);
        ...
        <div className="auth-card" style={{ maxHeight: "85vh", display: "flex", flexDirection: "column" }}>
          <div style={{ padding: "40px 40px 20px 40px", borderBottom: "1px solid rgba(255,255,255,0.05)", flexShrink: 0 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
              <div>
                ...
                <h1 className="auth-card-title" style={{ textAlign: "left", margin: 0 }}>{t("legal.title")}</h1>
          ...
          <div className="legal-content custom-scrollbar" style={{ flex: 1, overflowY: "auto", padding: "20px 40px 40px 40px" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: "28px" }}>
              ...
              <section>
                ...
                <div style={{ color: "rgba(255,255,255,0.7)", fontSize: "0.9rem", lineHeight: "1.7" }}>
                  ...
                  <ul style={{ listStyleType: "disc", paddingLeft: "20px", marginTop: "8px", marginBottom: "8px" }}>
                    <li><strong>{t("legal.sections.s1.owner")}:</strong> Marco Antonio Falcón Hernández</li>
                    <li><strong>{t("legal.sections.s1.brand")}:</strong> SFFALCON</li>
                    <li><strong>{t("legal.sections.s1.app")}:</strong> SF Gestor Empresarial (app.sffalcon.com)</li>
                    <li><strong>{t("legal.sections.s1.web")}:</strong> <a href="https://www.sffalcon.com" target="_blank" rel="noopener noreferrer" style={{ color: "#818CF8" }}>www.sffalcon.com</a></li>
                    <li><strong>{t("legal.sections.s1.email")}:</strong> <a href="mailto:admin@sffalcon.com" style={{ color: "#818CF8" }}>admin@sffalcon.com</a></li>
                    <li><strong>{t("legal.sections.s1.phone")}:</strong> <a href="tel:+34604989742" style={{ color: "#818CF8" }}>+34 604 989 742</a></li>
                    <li><strong>{t("legal.sections.s1.country")}:</strong> {language === "en" ? "Spain (European Union)" : "España (Unión Europea)"}</li>
                  </ul>
                  <p>
                    {renderTextWithLinks(t("legal.sections.s1.p2"))}
                  </p>
                </div>
              </section>
              ...
              <section>
                <h2 style={{ color: "#818CF8", fontSize: "1rem", fontWeight: 700, marginBottom: "12px" }}>
                  {t("legal.sections.s2.title")}
                </h2>
                <div style={{ color: "rgba(255,255,255,0.7)", fontSize: "0.9rem", lineHeight: "1.7" }}>
                  <p>
                    {t("legal.sections.s2.p1")}
                  </p>
                  <ul style={{ listStyleType: "disc", paddingLeft: "20px", marginTop: "8px", marginBottom: "8px" }}>
                    {legalDict.sections.s2.items.map((item: string) => (
                      <li key={item}>{item}</li>
                    ))}
                  </ul>
                </div>
              ...
              <section>
                ...
                <div style={{ color: "rgba(255,255,255,0.7)", fontSize: "0.9rem", lineHeight: "1.7", display: "flex", flexDirection: "column", gap: "12px" }}>
                  ...
                  <div>
                    {t("legal.sections.s4.p2")}
                  </div>
                  <p>
                    {t("legal.sections.s4.p3")}
                  </p>
                </div>
              </section>
              ...
              <section>
                <h2 style={{ color: "#818CF8", fontSize: "1rem", fontWeight: 700, marginBottom: "12px" }}>
                  {t("legal.sections.s5.title")}
                </h2>
                <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "0.9rem", lineHeight: "1.7" }}>
                  {t("legal.sections.s5.p1")}
                </p>
              </section>
              ...
              <section>
                <h2 style={{ color: "#818CF8", fontSize: "1rem", fontWeight: 700, marginBottom: "12px" }}>
                  {t("legal.sections.s6.title")}
                </h2>
                <div style={{ color: "rgba(255,255,255,0.7)", fontSize: "0.9rem", lineHeight: "1.7" }}>
                  <p>{t("legal.sections.s6.p1")}</p>
                  <ul style={{ listStyleType: "disc", paddingLeft: "20px", marginTop: "8px", marginBottom: "8px" }}>
                    {legalDict.sections.s6.items.map((item: string) => (
                      <li key={item}>{item}</li>
                    ))}
                  </ul>
                  <p>
                    {t("legal.sections.s6.p2")}
                  </p>
                </div>
              </section>
              ...
              <section>
                <h2 style={{ color: "#818CF8", fontSize: "1rem", fontWeight: 700, marginBottom: "12px" }}>
                  {t("legal.sections.s7.title")}
                </h2>
                <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "0.9rem", lineHeight: "1.7" }}>
                  {renderTextWithLinks(t("legal.sections.s7.p1"))}
                </p>
              </section>
              ...
              <section>
                <h2 style={{ color: "#818CF8", fontSize: "1rem", fontWeight: 700, marginBottom: "12px" }}>
                  {t("legal.sections.s8.title")}
                </h2>
                <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "0.9rem", lineHeight: "1.7" }}>
                  {t("legal.sections.s8.p1")}
                </p>
              </section>
              ...
              <section>
                <h2 style={{ color: "#818CF8", fontSize: "1rem", fontWeight: 700, marginBottom: "12px" }}>
                  {t("legal.sections.s9.title")}
                </h2>
                <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "0.9rem", lineHeight: "1.7" }}>
                  {renderTextWithLinks(t("legal.sections.s9.p1"))}
                </p>
              </section>
              ...
              <section>
                <h2 style={{ color: "#818CF8", fontSize: "1rem", fontWeight: 700, marginBottom: "12px" }}>
                  {t("legal.sections.s10.title")}
                </h2>
                <div style={{ color: "rgba(255,255,255,0.7)", fontSize: "0.9rem", lineHeight: "1.7" }}>
                  <p>{t("legal.sections.s10.p1")}</p>
                  <ul style={{ listStyleType: "disc", paddingLeft: "20px", marginTop: "8px", marginBottom: "8px" }}>
                    {legalDict.sections.s10.items.map((item: string) => (
                      <li key={item}>{renderContactItem(item)}</li>
                    ))}
                  </ul>
                  <p>{t("legal.sections.s10.p2")}</p>
                </div>
              </section>
