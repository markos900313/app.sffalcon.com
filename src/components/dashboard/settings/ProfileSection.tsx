...
export default function ProfileSection({ 
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast.success(t('perfilActualizado'));
      onRefresh();
    } catch (error) {
      toast.error(t('errorGuardarPerfil'));
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                >
                  <option value="(GMT+01:00) Madrid">{language === 'en' ? '(GMT+01:00) Madrid' : '(GMT+01:00) Madrid'}</option>
                  <option value="(GMT+00:00) Londres">{language === 'en' ? '(GMT+00:00) London' : '(GMT+00:00) Londres'}</option>
                  <option value="(GMT-05:00) Nueva York">{language === 'en' ? '(GMT-05:00) New York' : '(GMT-05:00) Nueva York'}</option>
                </select>
